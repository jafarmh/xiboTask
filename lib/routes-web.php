...
// forgotPassword 
$app->get('/forgotPassword', '\Xibo\Controller\Login:forgotPassword')->name('forgotPassword');
$app->get('/forgotPasswordCode', '\Xibo\Controller\Login:forgotPasswordCode')->name('forgotPasswordCode');
$app->get('/forgotPasswordChangePass', '\Xibo\Controller\Login:forgotPasswordChangePass')->name('forgotPasswordChangePass');
...
$app->post('/forgotPassword', '\Xibo\Controller\Login:forgotPasswordEmail');
$app->post('/forgotPasswordCode', '\Xibo\Controller\Login:forgotPasswordVerify');
$app->post('/forgotPasswordChangePass', '\Xibo\Controller\Login:changePass');
